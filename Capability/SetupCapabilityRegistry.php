...
final class SetupCapabilityRegistry
{
    ...
    public static function builtIn(): self
    {
        return new self([
            ...
            new StaticSetupCapability('read_db.same_as_write', 'Same as write database', 'read_db'),
            new StaticSetupCapability('read_db.postgres_dedicated', 'PostgreSQL (dedicated read DB)', 'read_db',
                dockerEnvFactory: static fn(string $project, string $pwd) => [
